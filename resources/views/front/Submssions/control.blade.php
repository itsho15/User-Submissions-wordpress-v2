    ...
    <tbody>
        ...
        @foreach($submissions as $submission)
            <tr>
                ...
                @endphp
                <td> <a href="{{ get_edit_user_link( $submission->user_id )   }} "> {{ $Submmtionby->user_nicename }} </a></td>
            ...
            @include('front.Submssions.editmodelcontrol')

    @endforeach

    </tbody>

<form  id="deletedoc" method="post" action="{{ esc_url(url("admin/control/destroy/") ) }}" >
