...
<div id="edit_{{ $submission->id }}" class="modal fade " role="dialog">
    ...
    <div class="modal-dialog modal-lg">
        <form  method="POST" id="updatesub_{{ $submission->type  }}" action="<?php echo esc_url(url("admin/control/update/" . $submission->id)); ?>" enctype="multipart/form-data">
    <!-- Modal content-->
...
<div id="del_admin{{ $submission->id }}" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo esc_url(url("admin/control/destroy/" . $submission->id)); ?>" method="post" >
...
<div id="approve_{{ $submission->id }}" class="modal fade " role="dialog">
      <div class="modal-dialog modal-lg">
        ...
        <form name="Submission_edit_update" id="submitForm" method="POST" action="<?php echo esc_url(url("admin/control/approve/" . $submission->id)); ?>" enctype="multipart/form-data">
